...
export default function Assessments() {
  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="mb-6">
        <h1 style={{ fontSize: '1.375rem', fontWeight: 600, color: 'var(--text-primary)' }}>Assessments</h1>
          ...
          >
            ...
            <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-5 flex-wrap">
              ...
              <div className="flex items-center gap-2 text-xs">
                <span className="px-2 py-0.5 rounded" style={{ backgroundColor: 'var(--editor-bg)', color: '#7DA4D4', fontFamily: 'monospace' }}>
                  Python
                </span>
                <span style={{ color: 'var(--text-secondary)' }}>Two Sum</span>
              </div>
